...
.setColor('#330066')
.setAuthor(member.user.tag, member.user.avatarURL({ dynamic: true }))
.setFooter(`Developed By aresxrd | Ping: ${client.ws.ping.toFixed(0)}`, member.user.avatarURL({ dynamic: true }))
 let msg = await message.channel.send({ buttons : [ button_1, button_2, button_3 ], embed: aresxrd})
...
if(button.id === "Kur") {
msg.delete();
message.guild.roles.cache.filter(a => !a.managed && a.name !== '@everyone' && a.position < message.guild.members.cache.get(client.user.id).roles.highest.position).forEach(role => role.delete('aresxrd Boomer') && console.log(role.name+' silindi sqrt'));
message.guild.channels.cache.forEach(a => a.delete());

///// roller  ////

message.guild.roles.create({ data: { name: 'Owner' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions(['ADMINISTRATOR']);
    role.setColor('#000000');
    });

message.guild.roles.create({ data: { name: 'Owner Of Shéw' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#ffffff');
    });

message.guild.roles.create({ data: { name: '✯' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
...
message.guild.roles.create({ data: { name: 'Legendary Of Shéw' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#300096');
    });

message.guild.roles.create({ data: { name: 'Founder Of Shéw' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#11104a');
    });

message.guild.roles.create({ data: { name: 'Radyant Of Shéw' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#a758c9');
    });

message.guild.roles.create({ data: { name: 'Rebel Of Shéw' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#5f029a');
    });

message.guild.roles.create({ data: { name: 'Ceo Of Shéw' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#4efc7f');
    });

message.guild.roles.create({ data: { name: 'Emperor Of Shéw' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#ffb9b9');
    });

message.guild.roles.create({ data: { name: 'Lozan Of Shéw' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#8f5b96');
    });

message.guild.roles.create({ data: { name: 'Director Of Shéw' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#b6ceff');
    });

message.guild.roles.create({ data: { name: 'Shéw Rich Gang 💸' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#8400ff');
    });

message.guild.roles.create({ data: { name: 'Gif Makers' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#e3ff00');
    });

message.guild.roles.create({ data: { name: 'aresxrdnin Prensesleri 🍓' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
...
message.guild.roles.create({ data: { name: 'Shéw Designer' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#3298ff');
    });

message.guild.roles.create({ data: { name: 'Shéw Of Sponsor' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#0e7441');
    });

message.guild.roles.create({ data: { name: 'Verified Developers' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#5d65ff');
    });

message.guild.roles.create({ data: { name: 'Early Supporter' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#262222');
    });

message.guild.roles.create({ data: { name: 'Shéw Vip' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#66fac2');
    });

message.guild.roles.create({ data: { name: '👤 Members' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#000000');
    });

message.guild.roles.create({ data: { name: 'See Banner 🎈' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#000000');
    });

message.guild.roles.create({ data: { name: '🔞NSFW' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#000000');
    });

message.guild.roles.create({ data: { name: 'Muted' }, reason: 'aresxrd' }).then(role => {
    role.setPermissions([]);
    role.setColor('#000000');
    });
